...
<b>Note: To use the V2 API, you must place v2 in the call.</b>  
...
Example: http://api.worldbank.org/v2/vi/country/vir
...
<b>Download to CSC or EXCEL Formats</b>

+ CSV : Download .zip file that contains data, country metadata, and indicator metadata CSV files.

    Example:http://api.worldbank.org/v2/country/ind/indicator/AG.AGR.TRAC.NO?source=2&downloadformat=csv

+ EXCEL: Download .xls file that contains data, country metadata, and indicator metadata work sheets.
...
<b>Possible query strings for "dataformat":</b>
